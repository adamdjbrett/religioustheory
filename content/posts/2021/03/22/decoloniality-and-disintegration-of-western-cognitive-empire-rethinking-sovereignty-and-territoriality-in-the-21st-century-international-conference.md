...
*In order to offer opportunities for attendees to peruse the literature on decoloniality prior to the conference, we have provided a [pre-conference reading list](https://thenewpolis.com/docs/Reading_List.pdf).*

### **[Pre-conference Reading List](https://thenewpolis.com/docs/Reading_List.pdf)**